...
export const projectCaseStudies: readonly ProjectCaseStudy[] = [
  {
    ...
    overview: {
      en: [
        ...
        "The delivered system covers access control, attendance, inventory, stock orders, store operations, sales, reports, and management dashboards.",
      ],
      id: [
        "UKG System adalah aplikasi ERP web multi-cabang yang dibangun untuk CV Universal Kharisma Globalindo guna memusatkan alur operasional.",
        "Sistem yang dikirim mencakup kontrol akses, presensi, inventaris, order stok, operasional toko, penjualan, laporan, dan dashboard manajemen.",
      ],
    },
    contributions: {
      en: [
        "Designed the product flows and interface direction in Figma.",
        "Built the Next.js and React frontend for owner and employee workflows.",
        "Implemented NestJS business logic and REST endpoints across the core operational modules.",
        "Validated critical workflows with manual and automated Katalon tests, then deployed the system to an Ubuntu VPS.",
      ],
      id: [
        "Merancang alur produk dan arah antarmuka di Figma.",
        "Membangun frontend Next.js dan React untuk alur pemilik dan karyawan.",
        "Mengimplementasikan business logic NestJS dan endpoint REST pada modul operasional utama.",
        "Memvalidasi alur kritis melalui pengujian manual dan otomatis dengan Katalon, lalu melakukan deployment ke VPS Ubuntu.",
      ],
    },
    technicalNotes: {
      en: [
        "Role-based access separates owner and employee capabilities across multiple branches.",
        "Inventory movements connect stock orders, approvals, incoming stock, and store-level stock records.",
        "Sales transactions deduct stock, while cancellation restores the affected stock records.",
        "Operational and financial records feed reports and dashboard summaries.",
      ],
      id: [
        "Akses berbasis peran memisahkan kapabilitas pemilik dan karyawan pada banyak cabang.",
        "Pergerakan inventaris menghubungkan order stok, persetujuan, stok masuk, dan catatan stok tiap toko.",
        "Transaksi penjualan mengurangi stok, sedangkan pembatalan mengembalikan catatan stok terkait.",
        "Catatan operasional dan keuangan menjadi sumber laporan serta ringkasan dashboard.",
      ],
    },
    ...
    cover: {
      ...
      alt: {
        en: "UKG System administration dashboard with operational charts",
        id: "Dashboard administrasi UKG System dengan grafik operasional",
      },
      position: "top",
    },
    evidence: [
      {
        ...
        caption: { en: "Operational interface from the production system.", id: "Antarmuka operasional dari sistem production." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "A documented view from the multi-branch workflow.", id: "Tampilan terdokumentasi dari alur multi-cabang." },
      },
      {
        id: "FIG.03",
        ...
        caption: { en: "Data management evidence from the delivered application.", id: "Bukti pengelolaan data dari aplikasi yang dikirim." },
      },
    ],
  ...
  },
  {
    ...
    contributions: {
      en: [
        ...
        "Connected the Random Forest inference service through Flask and integrated ESP32 data through the Laravel layer.",
        "Tested the application with Katalon and deployed the containerized system on Ubuntu.",
      ],
      id: [
        ...
        "Menghubungkan layanan inferensi Random Forest melalui Flask serta mengintegrasikan data ESP32 melalui lapisan Laravel.",
        "Menguji aplikasi dengan Katalon dan melakukan deployment sistem berbasis container di Ubuntu.",
      ],
    },
    technicalNotes: {
      en: [
        "Three roles separate patient, administrator, and health-worker responsibilities.",
        "Screening workflows cover DSMQ, HSMBQ, and DASS-21 instruments.",
      ...
      id: [
        ...
        "Alur screening mencakup instrumen DSMQ, HSMBQ, dan DASS-21.",
    ...
    evidence: [
      {
        ...
        caption: { en: "A documented patient-facing view of iHealth Edu.", id: "Tampilan iHealth Edu untuk pasien yang terdokumentasi." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "Interface evidence from the structured education workflow.", id: "Bukti antarmuka dari alur edukasi terstruktur." },
      },
    ],
    claimBoundary: {
  ...
  },
  {
    ...
    technicalNotes: {
      en: [
        ...
        "The forum provides a dedicated space for community discussion.",
      ...
      id: [
        ...
        "Forum menyediakan ruang khusus untuk diskusi komunitas.",
    ...
    evidence: [
      {
        ...
        caption: { en: "A documented education-platform view.", id: "Tampilan platform edukasi yang terdokumentasi." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "Content interface from the delivered platform.", id: "Antarmuka konten dari platform yang dikirim." },
      },
    ],
  },
  {
    ...
    overview: {
      en: [
        "Nusa Dakwah is a full-stack digital dakwah platform for structured learning content and community discussion.",
    ...
    evidence: [
      {
        ...
        caption: { en: "A documented view of the digital content platform.", id: "Tampilan terdokumentasi dari platform konten digital." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "Interface evidence from the structured content journey.", id: "Bukti antarmuka dari perjalanan konten terstruktur." },
      },
    ],
  },
  {
    ...
    evidence: [
      {
        ...
        caption: { en: "A documented inventory-management view.", id: "Tampilan pengelolaan inventaris yang terdokumentasi." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "Interface evidence from the stock workflow.", id: "Bukti antarmuka dari alur stok." },
      },
    ],
  },
  {
    ...
    evidence: [
      {
        ...
        caption: { en: "Structured data submitted to the inference workflow.", id: "Data terstruktur yang dikirim ke alur inferensi." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "Documented output from the prediction service.", id: "Output terdokumentasi dari layanan prediksi." },
      },
    ],
    claimBoundary: {
    ...
    evidence: [
      {
        ...
        caption: { en: "Documented media output with generated subtitles.", id: "Output media terdokumentasi dengan subtitle yang dihasilkan." },
      },
    ],
  },
  {
    ...
    evidence: [
      {
        ...
        caption: { en: "Android service interface for printer setup.", id: "Antarmuka layanan Android untuk pengaturan printer." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "Documented printer-profile configuration flow.", id: "Alur konfigurasi profil printer yang terdokumentasi." },
      },
      {
        id: "FIG.03",
        ...
        caption: { en: "Mobile calibration and service-state evidence.", id: "Bukti kalibrasi dan status layanan pada mobile." },
      },
    ],
  },
  {
    ...
    evidence: [
      {
        ...
        caption: { en: "Mobile competition-data presentation.", id: "Penyajian data kompetisi pada mobile." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "Documented fixture and navigation view.", id: "Tampilan jadwal dan navigasi yang terdokumentasi." },
      },
      {
        id: "FIG.03",
        ...
        caption: { en: "Club and competition interface evidence.", id: "Bukti antarmuka klub dan kompetisi." },
      },
    ],
  },
  {
    ...
    evidence: [
      {
        ...
        caption: { en: "A rendered panorama used by the Unity prototype.", id: "Panorama hasil render yang digunakan oleh purwarupa Unity." },
      },
      {
        id: "FIG.02",
        ...
        caption: { en: "Documented navigation view between panoramic scenes.", id: "Tampilan navigasi terdokumentasi di antara scene panorama." },
      },
      {
        id: "FIG.03",
        ...
        caption: { en: "Visual evidence from the completed internship prototype.", id: "Bukti visual dari purwarupa kerja praktik yang selesai." },
      },
    ],
  },
] as const;
