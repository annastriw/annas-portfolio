...
export function AboutProfile({ locale }: AboutProfileProps) {
  ...
  return (
    <section
      className="about-profile-section py-8 sm:py-12 md:py-16 border-b border-(--color-border)"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] xl:grid-cols-[360px_1fr] gap-8 lg:gap-12 xl:gap-16 items-start">
          ...
          <div className="order-1 lg:order-none lg:col-start-2 lg:row-start-1 flex flex-col gap-6">
            ...
            >
              ...
              <p className="text-base sm:text-lg lg:text-xl text-(--color-foreground) font-medium leading-relaxed m-0 max-w-2xl">
                {data.lead[locale]}
              </p>
            </ScrollReveal>
          </div>
              ...
              <figure className="m-0 flex flex-col gap-2 w-full">
                <div className="border border-(--color-border) p-1.5 bg-(--color-background) aspect-[3/4] relative overflow-hidden shadow-2xs">
                  <Image
                    ...
                    height={480}
                    priority
                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 360px, 360px"
          ...
          <div className="order-3 lg:order-none lg:col-start-2 lg:row-start-2 flex flex-col gap-4 max-w-2xl pt-2 lg:pt-0">
            ...
            >
              <div className="border-t border-(--color-border) pt-5 flex flex-col gap-4 text-sm sm:text-base text-(--color-muted) leading-relaxed">
