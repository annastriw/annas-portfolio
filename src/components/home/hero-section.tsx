      ...
      <div className="home-hero-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="home-hero-layout grid grid-cols-1 lg:grid-cols-[1.35fr_1fr] gap-6 lg:gap-x-12 xl:gap-x-16 lg:gap-y-6 items-start">
            ...
            <div className="hero-intro-header lg:col-start-1 lg:row-start-1 flex items-center gap-2.5 font-mono text-xs text-(--color-muted) border-b border-(--color-border)/60 pb-2.5">
            ...
            {/* 2. Greeting & Prominent Name (Instrument Serif matching About page) */}
            <div className="hero-identity-block lg:col-start-1 lg:row-start-2 flex flex-col gap-1.5 pt-0.5">
              ...
              <h1 className="home-hero-name font-serif text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] xl:text-[3.5rem] font-normal tracking-tight text-(--color-foreground) leading-[1.08] m-0">
                {copy.name}
              </h1>
            </div>

            {/* 3. Alternating Role Animation with 3 Integrated Dot Indicators */}
            <div className="hero-role-block lg:col-start-1 lg:row-start-3">
              <ContinuousRoles locale={locale} />
            </div>
            ...
            {/* 5. Portrait Evidence Frame (Directly below Bio on Tablet/Mobile; Right Col on Desktop) */}
            ...
            {/* 6. Location, Live Clock & Collaboration Indicator with Gentle Pulse */}
            <div className="hero-meta-rail lg:col-start-1 lg:row-start-6 flex flex-wrap items-center gap-2.5 sm:gap-3 border-t border-(--color-border) pt-3.5 font-mono text-xs text-(--color-muted)">
            ...
            {/* 7. Redesigned Primary Bordered & Secondary Borderless CTAs */}
            <div className="home-hero-actions lg:col-start-1 lg:row-start-5 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1">
              <Link
