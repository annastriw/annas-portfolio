...
export function TechStackSection({ locale }: TechStackSectionProps) {
  ...
  return (
    <section
      className="home-tech-section py-8 sm:py-10 md:py-12 lg:py-16"
      aria-label={copy.title}
    >
      <div className="home-tech-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-5 sm:gap-6">
